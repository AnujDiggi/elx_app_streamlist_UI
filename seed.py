...
SIMULATE_PARAM_GROUPS = [
    {
        ...
        "expanded": True,
        "tags": [{"text": "DD%", "class": "dd"}, {"text": "4 Parameters", "class": "fields"}],
        "fields": [
            {"name": "Direct Delivery Share (%)",
             "description": "% of orders delivered directly — affects PTC and STC volumes — Range: 0–100%",
             "value": 15, "min": 0, "max": 100, "step": None, "suffix": "%",
             "name_tags": []},
        ],
    },
    {
        ...
        "tags": [
            {"text": "STC", "class": "stc"},
            {"text": "PTC", "class": "ptc"},
            {"text": "4 Parameters", "class": "fields"},
        ],
        "fields": [
            {"name": "STC Fuel Inflation",
             "description": "Fuel cost inflation applied to all secondary (last-mile) transport",
             "value": 3.4, "min": None, "max": None, "step": 0.1, "suffix": "%",
             "name_tags": [{"text": "STC", "class": "stc"}]},
            {"name": "STC Other Inflation",
             "description": "Non-fuel inflation: labour, tolls, handling charges",
             "value": 2.3, "min": None, "max": None, "step": 0.1, "suffix": "%",
             "name_tags": [{"text": "STC", "class": "stc"}]},
            {"name": "PTC Fuel Inflation",
             "description": "Fuel cost inflation for long-haul primary and inter-depot transport",
             "value": 1.5, "min": None, "max": None, "step": 0.1, "suffix": "%",
             "name_tags": [{"text": "PTC", "class": "ptc"}]},
            {"name": "PTC Other Inflation",
             "description": "Non-fuel inflation for primary transport operations",
             "value": 4.5, "min": None, "max": None, "step": 0.1, "suffix": "%",
             "name_tags": [{"text": "PTC", "class": "ptc"}]},
        ],
    },
    {
        "icon": "🏢",
        "title": "Warehouse Costs (SWC)",
        "description": "Variable and fixed cost inflation for warehouse operations",
        "expanded": False,
        "tags": [{"text": "SWC", "class": "swc"}, {"text": "5 Parameters", "class": "fields"}],
        "fields": [],
    },
    {
        "icon": "💼",
        "title": "Project Costs (EUR)",
        "description": "One-time and planned initiative costs for this planning cycle",
        "expanded": False,
        "tags": [{"text": "16 categories", "class": "cat"}, {"text": "4 entered", "class": "entered"}],
        "fields": [],
    },
]
...
SIMULATE_STATUS_ROWS = [
    {"name": "DD% (1 field)",        "pill": "done",    "pill_text": "Done"},
    {"name": "Inflation (4 fields)", "pill": "done",    "pill_text": "Done"},
    {"name": "SWC (2 fields)",       "pill": "done",    "pill_text": "Done"},
    {"name": "Project costs",        "pill": "partial", "pill_text": "4 / 16"},
]
